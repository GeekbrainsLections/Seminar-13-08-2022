...
Для того, чтобы слить ветки, необходимо перейти в ветку, в которую Вы хотите добавить изменения и написать команду *git merge <название ветки из которой хотите добавить изменения>*. При возникновении конфликта необходимо вручную его исправить и закоммитить изменения.

## Удаление веток
Для удаления веток используетя команда *git branch -d <название ветки>*.

## Работа с удаленными репозиториями
Для того, чтобы загрузить удаленный репозиторий или его изменения, необходимо использовать команду *git pull <ссылка на удаленный репозиторий>* Для того, чтобы перенести изменения из локального репозитория в удаленный, необходимо использовать команду *git push <ссылка на удаленный репозиторий>*.
