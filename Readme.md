...
Для того, чтобы добавить удаленный репозиторий, вы можете запустить команду *git clone <ссылка на репозиторий>*
...
## Примечание
Команда *git branch -M main* переименовывает ветку master на локальном репозитории в main.
