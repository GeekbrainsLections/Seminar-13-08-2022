...
Для работы с чужим удаленным репозиторием необходимо на GitHub выполнить *fork* нужного репозитория, затем скопировать ссылку на этот репозиторий. Чтобы начать работу с этим репозиторием необходимо в терминале написать команду *git clone <ссылка>*, а затем перейти в папку, выполнив команду *cd <имя папки>*. 

###  Получение изменений
Чтобы получить изменения из удаленного репозитория используется команда *git fetch*.
Для того чтобы получить и замерджить изменения из удаленного репозитория в терминале необходимо ввести команду *git pull*. 

### Отправка изменений
Командой *git push* можно отправить изиенения в удаленный репозиторий.