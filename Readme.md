...
Для того, чтобы начать работу с удаленными репозиториями необходимо авторизоваться на сайте *github.com*. Для работы используются следующие команды: 
* *git_pull* - данная команда *вытягивает* из удаленного репозитория в локальный актуальный файл со всеми изменениями.
* *git_push* - данная команда отправляет локальный репозиторий в удалённый. 
* *git_ clone* - данная команда позволяет скопировать с сайта GitHub полную папку какого-либо проекта со всеми его файлами.
